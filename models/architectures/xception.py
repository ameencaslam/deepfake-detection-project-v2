...
class XceptionModel(BaseModel):
    """Xception model with improved feature extraction and attention."""
    ...
    def __init__(self,
        ...
        # Feature processing
        self.conv1x1 = nn.Conv2d(self.feature_dim, hidden_dim, kernel_size=1)
    ...
    def forward(self, x: torch.Tensor) -> torch.Tensor:
        ...
        # Process features
        features = self.conv1x1(features)  # [B, hidden_dim, H, W]
        ...
        features = features.mean(dim=(2, 3))  # [B, hidden_dim]
    ...
    def configure_optimizers(self) -> Tuple[torch.optim.Optimizer, Optional[torch.optim.lr_scheduler._LRScheduler]]:
        ...
        attention_params = list(self.attention.parameters()) if self.use_attention else []
